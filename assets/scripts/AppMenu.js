    ...
    if(!!evaluationResultsPage){
        ...
        menuBtnIcon.innerHTML = `
            <svg width="100%" height="100%" viewBox="0 0 40 40" class="donut" role="img" aria-label="Percentagem de conclusão">
                ...
                <g class="donut-checklist" stroke-width=".70061" transform="matrix(0.765,0,0,30,4.6998879,4.7000153)">
                    <path d="M19.502 28.076l.098.117.102.113-.199-.23z" paint-order="markers stroke fill"/><path d="M19.314 27.836l.092.121.096.119-.187-.24zm-.341-.506l.08.131.084.127-.164-.258z" paint-order="markers stroke fill"/><path d="M18.82 27.064l.074.135.078.131-.152-.266z" paint-order="markers stroke fill"/><path d="M12.994 11.594c-.879-.027-1.526.852-1.4 1.686l.007 13.869c.061.849.931 1.373 1.726 1.258l13.822-.007c.849-.061 1.373-.931 1.258-1.726l-.007-13.822c-.061-.849-.931-1.373-1.726-1.258H12.994zm.35 1.4h13.312c.52.08.304.695.35 1.063v2.722c-2.974-1.118-6.564-.125-8.548 2.355-1.811 2.14-2.273 5.298-1.167 7.871h-3.947c-.52-.08-.304-.695-.35-1.063V13.344a.35.35 0 0 1 .35-.35zm11.061 4.691c.847.059 2.065.092 2.602.697v8.273c-.08.52-.695.304-1.063.35h-7.152c-1.357-2.473-.785-5.81 1.341-7.674a6.34 6.34 0 0 1 4.272-1.647zm2.756.625c.333.114 1.493.937.67.373a6.63 6.63 0 0 0-.67-.373zm-8.34 8.754l.074.135zm.494.771l.092.121z" paint-order="markers stroke fill"/><path d="M27.434 18.451l-.137-.072-.137-.068.273.141z" paint-order="markers stroke fill"/><path d="M27.701 18.604l-.133-.078-.135-.074.268.152z" paint-order="markers stroke fill"/><path d="M27.957 18.768l-.127-.084-.129-.08.256.164z" paint-order="markers stroke fill"/><path d="M28.207 18.945l-.123-.09-.127-.088.25.178z" paint-order="markers stroke fill"/><g stroke="#494c4e"><g stroke-width="1.3" stroke-linejoin="round"><circle cx="25.204" cy="19.857" r=".6" paint-order="markers stroke fill"/><circle cx="21.328" cy="21.179" r=".6" paint-order="markers stroke fill"/><circle cx="20.287" cy="24.997" r=".6" paint-order="markers stroke fill"/></g><circle cx="24.57" cy="24.342" r="1" stroke-width="2.165" paint-order="markers stroke fill" stroke-linejoin="round"/></g>
                </g>
